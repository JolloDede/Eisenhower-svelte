...
<Modal bind:show>
	<div class="grid space-y-4 m-4 bg-white">
		<div class="flex py-2 text-center">
			...
			<button class="border rounded-md py-1 px-2 mr-2 hover:bg-gray-200" on:click={() => handleEditClick(record)}>Edit</button>
		...
		<p>Datum: {record.endDateStr.toLocaleDateString()}</p>
	</div>
</Modal>
